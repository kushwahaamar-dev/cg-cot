...
\begin{figure}[h]
    ...
    \caption{The Reliability Gap and its Solution. Generalist models (Mistral-7B, orange) suffer from low reliability on MATH and FOLIO due to frequent crashes. In contrast, the Specialist Verifier (Qwen-Coder, green) achieves \textbf{100\% Reliability} (0\% crash rate), successfully bridging the gap.}
