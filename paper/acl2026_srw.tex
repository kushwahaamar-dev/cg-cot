...
\begin{figure}[h]
    ...
    \caption{The Reliability Gap. On GSM8K, the Recovery Rate (green) exceeds the Crash Rate (red), indicating a net positive neurosymbolic loop. On MATH and FOLIO, the high Crash Rate overwhelms the system, preventing effective recovery.}
